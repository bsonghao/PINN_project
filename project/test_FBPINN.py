...
def main():
    ...
    # build FBPINN ansatz
    if False: # primary implmentation of FBPINN ansatz
        network = FBPINN(
    ...
    # setup optimizers
    # LBFGS optimizer
    optimizer_LBFGS = optim.LBFGS(network.parameters(),
                              lr=float(0.5),
                              max_iter=50000,
                              max_eval=50000,
                              history_size=150,
    ...
    # ADAM optimizer
    optimizer_ADAM = optim.Adam(network.parameters(),lr=float(0.001))
